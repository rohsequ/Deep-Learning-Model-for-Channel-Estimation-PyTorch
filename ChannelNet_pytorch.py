...
if __name__ == "__main__":
    ...
    train_SRCNN(train_size, test_size, my_dataset, n_epochs, model_name, device, load_from_checkpoint)

    print("Data is ready for training.\nTraining the DnCNN first....")
    model_name = "DnCNN"

    train_DnCNN(train_size, test_size, my_dataset, n_epochs, model_name, device, load_from_checkpoint, "saved_models\SRCNN_checkpoint_latest.pt")
